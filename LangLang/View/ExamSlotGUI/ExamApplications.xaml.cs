...
namespace LangLang.View.ExamSlotGUI
{
    ...
    public partial class ExamApplications : Window
    {
        ...
        private void DeleteBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                studentController.Delete(SelectedStudent.Id, appController.EnrollmentRequestController, appController.ExamAppRequestController, appController.ExamSlotController);
                Update();
                ShowSuccess();
            }
        }
